...
const Email = () => {
    ...
    return (
        <div>
          ...
          <h1 className="text-xl font-bold">Financial updates via Email</h1>
          <div>
            <label className="mr-3 font-semibold">Recipient Type:</label>
            <select
              value={recipientType}
              onChange={(e) => setRecipientType(e.target.value)}
              className="bg-white text-blue-900 px-4 py-2 rounded-md border border-gray-300"
            >
